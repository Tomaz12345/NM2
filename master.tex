...
\begin{proof}
    ...
    \alpha_n \ell_{n, n} = 0 <=> \alpha_0 = \alpha_1 = \dots = \alpha_n = 0$.
...
\begin{conseq}
    ...
    \end{equation}
    Lagrangevi bazni polinomi tvorijo $\textbf{razčlenitev}$ oziroma $\textbf{particijo enote}$, ki pozitivno vpliva na stabilnost baze.
\end{conseq}
...
\begin{theorem}
    Naj bo $A \in \R^{n \times m}$ in naj bo $|\lambda_1| > |\lambda_2| \geq |\lambda_3| \geq \dots \geq |\lambda_n| \geq 0$ njene lastne vrednosti.
    Potem za poljubni začetni vektor $z_0$ zaporednje vektorjev $(z_k)_k$, ki ga tvori potenčna metoda, konvergira (numerično) proti dominantnemu lastnemu 
